...
def updates(item):
    logger.info("[thegroove360.cb01io] updates")
...
def menuhd(item):
    logger.info("[thegroove360.cb01io] menuhd")
    return menulist(item, '<select name="select1"(.*?)</select>')


def menuanyos(item):
    logger.info("[thegroove360.cb01io] menuvk")
...
def search(item, texto):
    logger.info("[thegroove360.cb01io] " + item.url + " search " + texto)
...
def listserie(item):
    logger.info("[thegroove360.cb01io] listaserie")
    itemlist = []
...
def episodios_serie_new(item):
    ...
    logger.info("[thegroove360.cb01io] episodios")
...
def findvid_film(item):
    ...
    logger.info("[thegroove360.cb01io] findvid_film")
...
def play(item):
    logger.info("[thegroove360.cb01io] play")
    itemlist = []
